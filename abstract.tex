\begin{abstract}
    ...
    We propose and evaluate \emph{circumcircle filtering}, a technique to
    improve the recovery of the LVR complex, and demonstrate why it becomes
    unnecessary in high-dimensional spaces of real-world datasets. 
\end{abstract}